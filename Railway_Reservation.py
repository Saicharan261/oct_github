import random #we can select the data randomly,like numbers
import pickle  #we store the data in pickle
import sys  #system,because we system related functions
...
class train:
    ...
    class acceptors:
        '''Class containing function for accepting and 
        ...
        def accept_menu_option():
            ...
            if option not in ('1','2','3','4','5','6','7','8'):
                pritn("please enter a vaild option!")
        ...
        def book_ticket():
            ...
            if trains[choice].check_availablity(coach,ticket_num):
                ...
                print(ticket_num,"tickets not availble")
                menu()
        def cancel_ticket():
            ...
            if pnr in ticket_dict:
                ...
                if prompt == 'y':
                    if logged_in:
                        ...
                        trains[ticket_dict[pnr].uid].history[pnr]
                        del ticket_dict[pnr]
                    else:
        ...
        def check_seat_availablity(flag = ''):
            ...
            des = input("Enter the destinatioon station:- ")
            flag_2 = 0
            for i in trains:
...
u1 = users(1111,'kiran','cuttack','7478021777','kiran')
u2 = users(2322,'alex parrish','new york','7873752967','alexparrish')
